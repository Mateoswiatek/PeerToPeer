echo '{"type": "NewTaskRequest", "passwordHash": "89420ef764ba98728f16a21c5da122f25fdc936b535bbf0d5ccf1ba0ec6dab3b", "alphabet": "abcdoijklms", "maxLength": 6, "maxBatchSize": 40}' | nc localhost 5000
